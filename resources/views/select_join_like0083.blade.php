...
<body>
    ...
    <table>
        ...
        <?php
                ...
                $q = $link->query("SELECT * FROM ((anggota INNER JOIN pinjam ON anggota.anggota_id = pinjam.anggota_id) INNER JOIN buku ON pinjam.buku_id = buku.buku_id) where anggota.anggota_alamat like 's%'");  
